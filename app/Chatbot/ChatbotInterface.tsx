  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I can help you send tokens or answer crypto/price related questions. Try asking me to send 1 ETH to an address or a GoldenEagle username.',
      timestamp: new Date()
    }
  ]);
    ...
    try {
      ...
      if (!apiKey || apiKey.trim() === '') {
        const fallbackMessage: ChatMessage = {
          id: Date.now().toString(),
          role: 'assistant',
          content: "I'm sorry, I can only perform sends and price fetching at the moment. Try using these commands:\n\n" +
