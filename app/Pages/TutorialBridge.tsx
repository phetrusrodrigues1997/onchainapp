          ...
          <div className="p-0 sm:p-4 md:p-6">
            ...
            <div className="flex items-center gap-3 mb-6 sm:mb-3 pl-2 pr-4 sm:px-0">
              ...
              <div className="flex-shrink-0">
                <div className="w-20 h-20 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-lg overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
