  ...
  return (
    <div className="relative text-center mb-72 lg:transform lg:translate-y-16 px-4 max-w-lg mx-auto">
      ...
      <div className="top-0 z-10 bg-transparent rounded-b-2xl pb-4 shadow-lg">
        ...
        <div className="relative mx-auto mb-6 p-6 rounded-2xl bg-[#333333] overflow-hidden">
          <div className="absolute inset-0 rounded-2xl bg-[#333333] opacity-50 animate-gradient-x"></div>
        ...
        {selectedTabTotalUSD === 0 ? (
          ...
          <div className="space-y-3">
            ...
            {selectedTab === 'crypto' && nativeBalance.data && parseFloat(nativeBalance.data.formatted) > 0 && (
              <div className="bg-[#333333] p-4 rounded-xl shadow-lg border border-gray-800/50 hover:border-gray-700/70 transition-all duration-300 flex items-center group">
            ...
            {tokenBalances.map((balance, index) => {
              ...
              if (
                ...
                return (
                  <div
                    key={token.address}
                    className="bg-[#333333] p-4 rounded-xl shadow-lg border border-gray-800/50 hover:border-gray-700/70 transition-all duration-300 flex items-center group"
                  >
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-r from-[#d3c81a]/20 to-transparent rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                      <img
