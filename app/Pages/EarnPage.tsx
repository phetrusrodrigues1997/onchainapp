...
//               ? "bg-[#d3c81a] text-black font-semibold"
...
//         {earnSection === "deposit" && (
//           <EarnDeposit className="bg-[#101010] p-4 sm:p-6 rounded-md border border-gray-600 shadow-md w-full max-w-sm mx-auto rounded border">
//             {/* <TokenSelect/> */}
...
//           <EarnWithdraw className="bg-[#101010] p-4 sm:p-6 rounded-md border border-gray-600 shadow-md w-full max-w-sm mx-auto rounded border">
//             {/* <TokenSelect /> */}
//             <EarnDetails className="text-gray-900 font-semibold text-lg sm:text-xl mb-4" />
