...
/>
  ...
  <SwapAmountInput
    ...
    type="to"
    className="mb-1 bg-[#1b1b1b] backdrop-blur-lg rounded-2xl border border-white/20 shadow-lg text-white rounded-2xl hover:border-[#d3c81a] hover:shadow-[#d3c81a]/50 transition-all duration-300 ease-in-out transform hover:scale-[1.02] focus-within:ring-2 focus-within:ring-[#d3c81a]/70"
  />
